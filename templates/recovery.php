<div class="module module-padded" id="recovery-left">
	<div class="recovery-icon recovery-icon-default"></div><h1>Select an option...</h1>
	<p>Recovering access to your account is easy, the first step is to select one of the options on the right-hand side of the page.</p>
	<div id="recovery-footer">
		<img src="http://static.fundraisingquizzes.net/images/key2_64.png"/>
		<img src="http://static.fundraisingquizzes.net/images/right_64.png"/>
		<img src="http://static.fundraisingquizzes.net/images/letter_64.png"/>
	</div>
</div>
<div class="module module-padded" id="recovery-right">
	<h1>Recovery Options</h1>
	<ul id="recover-options">
		<li><a class="recover-password">&raquo; I've forgotten my account password.</a></li>
		<li><a class="recover-username">&raquo; I've forgotten my account username.</a></li>
		<li><a class="recover-both">&raquo; I've forgotten both my username and password.</a></li>
		<li><a class="recover-email">&raquo; I can't access my e-mail account!</a></li>
	</ul>
</div>
...
<div id="slides">
	...
	<div id="recover-email-slide">
		<div class="recovery-icon recovery-icon-email"></div><h1>Forgotten E-mail</h1>
		<p>If you cannot access your e-mail account, you'll have to register a new account with a new e-mail address sadly.</p>
		<p class="center register-link"><a href="register.php">Click here to register for a new account.</a></p>
	</div>
</div>